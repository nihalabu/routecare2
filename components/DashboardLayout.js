...
export default function DashboardLayout({ children, role }) {
    ...
    const nriLinks = [
        ...
        { href: '/nri/reviews', label: 'Reviews', icon: 'star' },
        { href: '/nri/profile', label: 'Profile', icon: 'user' },
    ];

    const adminLinks = [
        { href: '/admin/dashboard', label: 'Dashboard', icon: 'home' },
        { href: '/admin/users', label: 'Users (NRIs)', icon: 'users' },
        { href: '/admin/workers', label: 'Workers', icon: 'briefcase' },
        { href: '/admin/requests', label: 'Service Requests', icon: 'clipboard' },
    ];

    const navLinks = role === 'caretaker' ? caretakerLinks : role === 'admin' ? adminLinks : nriLinks;
            ...
            <div className={styles.mainContent}>
                ...
                <header className={styles.header}>
                    ...
                    <div className={styles.headerTitle}>
                        {role === 'caretaker' ? 'Caretaker Portal' : role === 'admin' ? 'Admin Portal' : 'NRI Portal'}
                    </div>
